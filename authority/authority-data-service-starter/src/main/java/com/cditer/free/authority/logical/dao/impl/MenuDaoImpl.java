...
public class MenuDaoImpl extends SuperDao<Menu> implements IMenuDao {
    ...
    private ISqlExpression roleSql(List<String> roleIds){
        ...
        ISqlExpression sqlExpression = SqlExpressionFactory.createExpression();
        sqlExpression.select("menu.id,menu.name,menu.title,menu.icon,menu.hidden,menu.path,menu.page_path,menu.lang_path,menu.type,menu.use_type,menu.parent_id,menu.theme,menu.sort_code,menu.delete_mark,menu.comments,menu.menu_mark,menu.level,menu.server_name")
