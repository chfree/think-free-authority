...
import com.cditer.free.file.dao.IFileBsnDao;
...
public class FileBsnServiceImpl extends SuperService<FileBsn> implements IFileBsnService {
    ...
    public FileBsnView queryViewModelBySearch(FileBsnSearch search) {
        return fileBsnDao.queryViewModelBySearch(search);
    }

    @Override
    public FileBsnView queryViewModelById(String id) {
    ...
    public boolean saveFileBsn(FileBsn fileBsn) {
        Integer seqIndex = queryNextSeqIndex(fileBsn.getBsnId(),fileBsn.getDisplayName());
    ...
    @Override
    public Integer queryNextSeqIndex(String bsnId, String displayName) {
        return fileBsnDao.queryNextSeqIndex(bsnId,displayName);
    }
