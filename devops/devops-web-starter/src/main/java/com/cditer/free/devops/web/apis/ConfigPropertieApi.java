...
public class ConfigPropertieApi extends TokenApi {
    ...
    public BaseResponse list(@RequestBody @Valid ConfigPropertieListReq listReq) {
        ...
        resp.setConfigProperties(configPropertieService.queryListViewBySearch(listReq.getSearch(), listReq.getPager()));
    ...
    public BaseResponse get(@Valid @NotBlank(message = "属性配置表id不能为空") String id) {
        ...
        ConfigPropertieView configPropertieView = configPropertieService.queryModelView(id);
        response.put("configPropertie", configPropertieView);
